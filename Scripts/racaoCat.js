const racoesCat = [
    { id: 0, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenSalmão.png', descricao: 'Ração Seca PremieR Pet Golden Gatos Adultos Salmão' },
    { id: 1, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenFrango.png', descricao: 'Ração Seca PremieR Pet Golden Gatos Adultos Frango' },
    { id: 2, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenCarne.png', descricao: 'Ração Seca PremieR Pet Golden Gatos Adultos Carne' },
    { id: 3, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenCastradoSalmão.png', descricao: 'Ração Seca PremieR Pet Golden Salmão para Gatos Castrados' },
    { id: 4, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenCastradoFrango.png', descricao: 'Ração Seca PremieR Pet Golden Frango para Gatos Castrados' },
    { id: 5, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenCastradoCarne.png', descricao: 'Ração Seca PremieR Pet Golden Carne para Gatos Castrados' },
    { id: 6, marca: 'PremierPet', precoKG: 19.00, precoSaco: 200.00, logo: 'Imagens/Marcas/Premier_Logo.png', img: 'Imagens/Gato/GoldenFilhote.png', descricao: 'Ração Seca PremieR Pet Golden Frango para Gatos Filhotes' },
